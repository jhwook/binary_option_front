...
export default function Test() {
  ...
  useEffect(() => {
    var chart = createChart(document.getElementById("ChartBox"), {
      width: 600,
      height: 300,
      timeScale: {
        timeVisible: true,
  ...
  return (
    <TestBox>
      <section id="ChartBox" className="innerSec"></section>
      <button className="" onClick={onClicBtn}>
        bbbbbb
      </button>
    </TestBox>
  );
