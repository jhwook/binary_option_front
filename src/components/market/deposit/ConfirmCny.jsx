      ...
      <div className="contArea">
        ...
        {limit > 0 ? (
          <div className="explainBox">
            ...
            <p>
              Please complete the payment within 15 minute(s). The coins you've
              bought will be credited to your Funding Account.
            </p>
          </div>
        ) : (
          <div className="canceledBox">
            ...
            <p>
              Unable to retrieve the payment method! The order has already been
              canceled.
            </p>
          </div>
        )}
